...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
		DWORD dwyanchi = g_pNt->OptionalHeader.DataDirectory[13].VirtualAddress;
		DWORD tempdwyanchi = RVAtoFOA(dwyanchi); 
		PIMAGE_DELAYLOAD_DESCRIPTOR pyanchi = (PIMAGE_DELAYLOAD_DESCRIPTOR)((char*)g_pFileImageBase + dwyanchi);
		str.Format(L"----------------------------------------------------延迟加载表-------------------------------------------------------------- \r\n");
		this->jiexipe.SetSel(-1);
		this->jiexipe.ReplaceSel(str);
		str.Format(L"DllNameRVA   %08X\n\r\n",pyanchi->DllNameRVA);
		this->jiexipe.SetSel(-1);
		this->jiexipe.ReplaceSel(str);
		str.Format(L"ModuleHandleRVA  %08X\n\r\n", pyanchi->ModuleHandleRVA);
		this->jiexipe.SetSel(-1);
		this->jiexipe.ReplaceSel(str);
		str.Format(L"ImportAddressTableRVA  %08X\n\r\n", pyanchi->ImportAddressTableRVA);
		this->jiexipe.SetSel(-1);
		this->jiexipe.ReplaceSel(str);
		str.Format(L"ImportNameTableRVA  %08X\n\r\n", pyanchi->ImportNameTableRVA);
		this->jiexipe.SetSel(-1);
		this->jiexipe.ReplaceSel(str);
		str.Format(L"BoundImportAddressTableRVA  %08X\n\r\n", pyanchi->BoundImportAddressTableRVA);
		this->jiexipe.SetSel(-1);
		this->jiexipe.ReplaceSel(str);
///////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////
